...
public class BookingService(
    ...
    IValidator<Booking> bookingValidator) : IBookingService
{
    ...
    {
        var booking = await bookingRepo.GetByIdAsync(bookingId) ?? throw new NotFoundException("Booking not found");
    ...
    public async Task<Booking?> GetByUserAndTickets(int userId,
        int ticketId)
    {
        ...
        var booking = await bookingRepo.GetByUserAndTicketAsync(userId,
            ticketId);
        if (booking == null)
